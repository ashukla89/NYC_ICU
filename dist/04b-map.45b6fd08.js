...
},{}],"scripts/nyc_icu/04b-map.js":[function(require,module,exports) {
"use strict";
...
var path = d3.geoPath().projection(projection); // const colorScale = d3.scaleSequential(d3.interpolatePiYG)
...
function ready(json) {
  ...
  console.log(json);
  var counties = topojson.feature(json, json.objects.us_counties); // colorScale.domain([1, -1])
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","/data/counties_with_election_data.topojson":"data/counties_with_election_data.topojson"}]},{},["scripts/nyc_icu/04b-map.js"], null)
//# sourceMappingURL=/04b-map.45b6fd08.js.map