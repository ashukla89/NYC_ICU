...
},{}],"scripts/nyc_icu/b-map.js":[function(require,module,exports) {
"use strict";
...
var svg = d3.select('#chart-b').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')'); // center the map projection on NYC as per: http://bl.ocks.org/phil-pedruco/6646844
...
function ready(_ref) {
  ...
  var boroughs = json.features; // const popExtent = d3.extent(datapoints, d => +d.population)
...
},{"d3":"../node_modules/d3/index.js","geojson":"../node_modules/geojson/geojson.js","/data/nyc.geojson":"data/nyc.geojson","/data/nyc_icu.csv":"data/nyc_icu.csv"}]},{},["scripts/nyc_icu/b-map.js"], null)
//# sourceMappingURL=/b-map.0e004cd9.js.map