...
},{"topojson-client":"../node_modules/topojson/node_modules/topojson-client/index.js","topojson-server":"../node_modules/topojson/node_modules/topojson-server/index.js","topojson-simplify":"../node_modules/topojson-simplify/index.js"}],"data/counties_with_election_data.topojson":[function(require,module,exports) {
module.exports = "/counties_with_election_data.d6d686ea.topojson";
},{}],"scripts/nyc_icu/04a-map.js":[function(require,module,exports) {
"use strict";
...
var opacityScale = d3.scaleLinear().range([0, 1]); // const pops = []
...
function ready(json) {
  ...
  colorScale.domain([1, -1]); // calculate range of county populations for opacityScale domain
  ...
  svg.selectAll('path').data(counties.features).enter().append('path').attr('class', 'country').attr('d', path).attr('fill', function (d) {
    return colorScale((d.properties.clinton - d.properties.trump) / (d.properties.clinton + d.properties.trump));
  }).attr('opacity', function (d) {
    return opacityScale(d.properties.clinton + d.properties.trump);
  });
}
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","/data/counties_with_election_data.topojson":"data/counties_with_election_data.topojson"}]},{},["scripts/nyc_icu/04a-map.js"], null)
//# sourceMappingURL=/04a-map.c68e0bc7.js.map