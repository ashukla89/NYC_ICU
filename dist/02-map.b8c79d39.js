...
},{"topojson-client":"../node_modules/topojson/node_modules/topojson-client/index.js","topojson-server":"../node_modules/topojson/node_modules/topojson-server/index.js","topojson-simplify":"../node_modules/topojson-simplify/index.js"}],"data/world.topojson":[function(require,module,exports) {
...
},{}],"scripts/nyc_icu/02-map.js":[function(require,module,exports) {
"use strict";
...
var projection = d3.geoEqualEarth().translate([width / 2, height / 2]).scale(125);
...
function ready(_ref) {
  ...
  svg.append('path').datum({
    type: 'Sphere'
  }).attr('d', path).attr('fill', 'lightblue').attr('stroke', 'black').attr('stroke-width', 2);
  svg.selectAll('.country').data(countries.features).enter().append('path').attr('class', 'country').attr('d', path).attr('fill', 'lightgrey').attr('stroke', 'black'); // add one circle for every world city

  svg.selectAll('circle').data(airports).enter().append('circle').attr('r', 2) // .attr('opacity', 1)
  ...
  var jfk = [-73.7781, 40.6513]; // hard-coded based on Google search

  var codes = airports.map(function (d) {
    return d.iata_code;
  });
  svg.selectAll('.transit').data(flights).enter().append('path').attr('d', function (d) {
    // Pull out our coordinates, if we have code for airport
    if (codes.includes(d.code) === true) {
      var toCoords = coordinateStore.get(d.code); // console.log(d.code)
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","/data/world.topojson":"data/world.topojson","/data/airport-codes-subset.csv":"data/airport-codes-subset.csv","/data/flights.csv":"data/flights.csv"}]},{},["scripts/nyc_icu/02-map.js"], null)
//# sourceMappingURL=/02-map.b8c79d39.js.map